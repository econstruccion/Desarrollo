		...
		<div id="contentleft" class="maincontent">
			...
			<div id="content" class="clearfix">
				...
				<div class="auth-bio auth-archive clearfix">
					...
					<?php } ?>
					<h1><?php _e(" ", "solostream"); ?> <?php echo $curauth->display_name; ?></h1>
					...
					<p class="auth-website"><a rel="external" title="<?php _e("Author's Website", "solostream"); ?>" href="<?php echo $curauth->user_url; ?>"><?php _e("Sitio Web del Autor", "solostream"); ?></a></p>
					<?php } ?>
