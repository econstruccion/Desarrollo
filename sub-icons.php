<div class="sub-icons clearfix">
	...
	<a title="<?php _e("Subscribe via RSS Feed", "solostream"); ?>" href="http://feeds.feedburner.com/econstruccion"><img class="rss-sub" src="<?php bloginfo('stylesheet_directory'); ?>/images/feed.png" alt="<?php _e("Subscribe via RSS Feed", "solostream"); ?>" align="top" /></a>
